...
import CursoSearchField from './CursoSearchField';
    ...
    <Stack direction={'row'} spacing={4}>
      <Menu>
        ...
        <MenuList>
          ...
          <MenuItem>Saúde & bem estar</MenuItem>
          <MenuItem>Educação</MenuItem>
          <MenuItem>Nutrição</MenuItem>
          <MenuItem>Markenting</MenuItem>
          <MenuItem>Contabilidade</MenuItem>
        </MenuList>
      </Menu>
      <CursoSearchField /> {/* Campo de busca */}
      <Box key={'Contato'} mt="8px" ml="70px">
        <Button
          as={'a'}
          color={'black'}
          fontSize={'14px'}
      ...
      <Box key={'Quem Somos'} mt="8px" ml="30px">
        <Button
          as={'a'}
          color={'black'}
          fontSize={'14px'}
